---
name: jscout
description: Use the jscout repository index to search authored Markdown and MDX, investigate known identifiers completely, or answer causal and cross-file questions with source-backed evidence in an indexed JavaScript or TypeScript project.
---
