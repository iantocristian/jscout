---
name: jscout
description: Use the jscout repository index to search authored Markdown, investigate known identifiers completely, or answer causal and cross-file questions with source-backed evidence in an indexed JavaScript or TypeScript project.
---
...
Start with the default hybrid posture. Set `vector: false` for a BM25-only comparison, and set
