    ...
    let mut tools = json!([
        {
            ...
            "description": "Hybrid (BM25 + embedding) search over the indexed codebase. Returns compact ranked code chunks and optional graph context; set debug for the full diagnostic representation.",
            "inputSchema": {
                "type": "object",
                "properties": {
