...
impl RuntimeConfig {
    ...
    pub fn show_text(&self) -> String {
        ...
        let mut lines = vec![
            ...
            format!(
                "docs: database={} freshness={} max_rank_movement={} include={:?} exclude={:?}",
                self.effective.docs.database.path.display(),
                self.effective.docs.freshness,
                self.effective.docs.max_rank_movement,
